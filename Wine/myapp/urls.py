...
urlpatterns = [
    ...
    path('wine_details/<str:wine_name>/<str:feature_name>/', views.feature_details, name='feature_details'),
    path('features/<str:wine_name>/<str:feature_name>/', views.features, name='features'),
